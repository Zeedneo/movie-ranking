...
import registor from "../register/register.css"
                            ...
                            <div className="cardRe text-black" style={{ borderRadius: "25px" }}>
                                <div className="cardRe-body p-md-12">
                                    <div className="row justify-content-center">
                                        <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1 block-left">
                                        ...
                                        <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                            ...
                                            <img src="ReMovieRank.PNG" className="img-fluid" alt="Sample image" />
